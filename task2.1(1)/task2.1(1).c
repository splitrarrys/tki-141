...
*/
double func_for_finding_area_of_a_trapezoid(const double upper_base, const double lower_base, const double height);
...
@return Возвращает значение площади трапеции
*/
double func_for_finding_area_of_circle(const double radius);
...
double func_for_finding_area_of_a_trapezoid(const double a, const double b, const double h)
{
    return (a + b) * h / 2;
}
